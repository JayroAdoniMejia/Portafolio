      ...
      <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          {PROJECTS_DATA.map((project) => {
            // Verificar si el proyecto tiene un repositorio de código público accesible
            const hasPublicRepo =
              project.githubUrl &&
              project.githubUrl !== "https://github.com" &&
              project.githubUrl !== "https://github.com/JayroAdoniMejia";
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-800/80 pb-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                      {hasPublicRepo ? (
                        ...
                        <span className="flex items-center gap-1.5 text-[11px] font-mono px-2.5 py-1 rounded-md bg-amber-500/10 text-amber-400 border border-amber-500/20">
